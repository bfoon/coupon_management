...
urlpatterns = [
    ...
    path('couponNew', views.couponNew, name='couponNew'),
    path('couponprint/<str:pk>', views.couponprint, name='couponprint'),
    path('bookreport/<str:pk>', views.bookreport, name='bookreport'),
    ...
    path('activitiesExport/<str:pk>', views.activitiesExport, name='activitiesExport'),
